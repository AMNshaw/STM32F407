#ifndef AGV_COMMUNICATION_PACK__ROSHOST_PROTOCOL_DEFS_H_
#define AGV_COMMUNICATION_PACK__ROSHOST_PROTOCOL_DEFS_H_
...
#define HOST_COMM_CMD_ODOMETRY_FEEDBACK 0x02
#define HOST_COMM_CMD_HEARTBEAT 0x03

// CRC-8 settings (這些不會出現在封包裡，但定義「怎麼算 Crc」)
#define ROSFMT_CRC_INIT 0x00  // 初始值
#define ROSFMT_CRC_POLY 0x07  // x^8 + x^2 + x + 1（去掉最高位）

#endif  // AGV_COMMUNICATION_PACK__ROSHOST_PROTOCOL_DEFS_H_
