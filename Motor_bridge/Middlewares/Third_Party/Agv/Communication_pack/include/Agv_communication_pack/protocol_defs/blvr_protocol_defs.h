...
#define BLVR_DATA_REG_ADDRESS_READ_DRIVER_ST 11
#define BLVR_DATA_REG_ADDRESS_READ_MEAS_POS 12
#define BLVR_DATA_REG_ADDRESS_READ_MEAS_VEL 14
#define BLVR_DATA_REG_ADDRESS_READ_PRESENT_ALRM 16
...
#define BLVR_DATA_REG_ADDRESS_WRITE_CMD_VEL 0
#define BLVR_DATA_REG_ADDRESS_WRITE_CMD_ACC 2
#define BLVR_DATA_REG_ADDRESS_WRITE_CMD_DEC 4
#define BLVR_DATA_REG_ADDRESS_WRITE_OPERATION_TYPE 6
#define BLVR_DATA_REG_ADDRESS_WRITE_OPERATION_TRIGGER 8
#define BLVR_DATA_REG_ADDRESS_WRITE_CMD_DRIVER 11
